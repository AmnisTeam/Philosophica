...
//		alphaExample();
	...
	public void colorExample(){
        ...
        LeanTween.color( lChar, new UnityEngine.Color(1.0f,0.0f,0.0f,0.5f), 0.5f ).setEase(LeanTweenType.easeOutBounce).setRepeat(2).setLoopPingPong().setUseEstimatedTime(useEstimatedTime);
	}
